...
public class A_QSort {
    ...
    int[] getAccessory(InputStream stream) throws FileNotFoundException {
        ...
        quickSort(segments, 0, n - 1); // сортировка отрезков

        // подсчет количества отрезков, которым принадлежит каждая точка
        for (int i = 0; i < m; i++) {
            int count = 0;
            int j = 0;
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        InputStream stream = new FileInputStream(root + "bby/it/group310971/Guzik/lesson05/dataA.txt");
