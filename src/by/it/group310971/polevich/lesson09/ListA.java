...
public class ListA<E> implements List<E> {
    ...
    // Конструктор по умолчанию, задающий начальную емкость списка
    public ListA() {
        elements = new Object[10]; // Изначально выделяем массив на 10 элементов
        size = 0;                 // Изначально список пустой
    }

    // Метод для увеличения емкости массива, если это необходимо
    ...
    public boolean add(E e) {
        ensureCapacity(size + 1); // Увеличиваем емкость массива при необходимости
    ...
    public E remove(int index) {
        ...
        elements[--size] = null; // Освобождаем память
    ...
    public boolean addAll(int index, Collection<? extends E> c) {
        ...
        System.arraycopy(newArray, 0, elements, index, numNew);
        size += numNew;
        return numNew != 0;
    }
