package by.it.group310971.stankevich.lesson07;
...
Необходимо:
    ...
    Итеративно вычислить алгоритм преобразования двух данных непустых строк
...
public class C_EditDist {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        InputStream stream = new FileInputStream(root + "by/it/group310971/stankevich/lesson07/dataABC.txt");
